...
namespace GameCore.TweenPresets.Infrastructure.TweenPreset
{
        ...
        where TUnit : TargetTweenUnit.TargetTweenUnit
    {
        ...
        [SerializeField] protected TTarget _tweenTarget;

        [Header("Values")]
        
        [SerializeField] protected TUnit _targetTweenUnit;
        ...
        public sealed override float Duration(bool playForward = true) 
            => _targetTweenUnit.AttachedTweenUnit.FullTweenDuration();
        ...
        {
            activeTween = HandlePlayAnimationTween(playForward).SetUpdate(_ignoreTimeScale);
